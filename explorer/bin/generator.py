...
if 'pegin_gen' in AVAILABLE_CHAINS[chain]['proc'] and 'parent_chain' in AVAILABLE_CHAINS[chain]['properties']:
    parent_chain_rpccaller = AVAILABLE_RPCS[ AVAILABLE_CHAINS[chain]['properties']['parent_chain'] ]
    pegin_gen_params = [chain, AVAILABLE_RPCS[chain], parent_chain_rpccaller]
...
if 'pegout_gen' in AVAILABLE_CHAINS[chain]['proc'] and 'parent_chain' in AVAILABLE_CHAINS[chain]['properties']:
    ...
    pegout_gen_params = [chain, AVAILABLE_RPCS[chain], parent_chain_rpccaller, parent_chain_has_CT]
